...
import org.devvikram.firstpmpproject.AndroidKtorClient
...
import org.devvikram.firstpmpproject.presentation.PostScreen
...
fun AppNavigation(navController: NavHostController,modifier: Modifier) {
    NavHost(
        ...
        composable<Destination.Post>() {
            val postClient = PostClient(AndroidKtorClient.ktorClient)
            PostScreen(postClient)
        }
    }
}
